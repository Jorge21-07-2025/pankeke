...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/volverse-rescatista', [AuthController::class, 'volverseRescatista'])->name('volverse.rescatista');
    ...
    Route::get('/guardados', [App\Http\Controllers\FavoriteController::class, 'page'])->name('favoritos.page');
    Route::get('/organizacion/{user}', [App\Http\Controllers\FavoriteController::class, 'organizacion'])->name('organizacion.show');
    ...
    Route::post('/emergencias', [App\Http\Controllers\EmergencyController::class, 'store'])->name('emergencias.store');
    Route::get('/emergencias/activas', [App\Http\Controllers\EmergencyController::class, 'activas'])->name('emergencias.activas');
    Route::post('/emergencias/{emergency}/asignar', [App\Http\Controllers\EmergencyController::class, 'asignar'])->name('emergencias.asignar');
    Route::post('/emergencias/{emergency}/resolver', [App\Http\Controllers\EmergencyController::class, 'resolver'])->name('emergencias.resolver');
});
